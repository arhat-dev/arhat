...
func init() {
	types.RegisterDeviceConnectivityFactory("file",
		aranyagopb.DEVICE_CONNECTIVITY_MODE_CLIENT, NewFileDeviceConnectivity)
}
...
var _ types.DeviceConnectivity = &fileDeviceConnectivity{}
...
func (s *fileDeviceConnectivity) Operate(params map[string]string) ([][]byte, error) {
	return s.doReadAfterWrite(params)
}

func (s *fileDeviceConnectivity) CollectMetrics(params map[string]string) ([][]byte, error) {
	return s.doReadAfterWrite(params)
}
